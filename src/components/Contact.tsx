      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="brutal-card bg-card p-8">
          ...
          <a 
            ...
            className="text-lg text-primary hover:underline mb-6 block"
          >
            dexter125555@gmail.com
          </a>
          <Button 
            onClick={() => window.location.href = 'mailto:dexter125555@gmail.com?subject=Hello Serish&body=Hi Serish,%0D%0A%0D%0AI found your portfolio and would like to connect.'}
            className="brutal-border bg-primary text-primary-foreground font-bold uppercase w-full h-12"
          >
